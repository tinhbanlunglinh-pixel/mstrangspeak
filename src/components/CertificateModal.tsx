          ...
          >
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex justify-center">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(to bottom right, #7F1D1D, #B91C1C)', border: '4px solid #ffffff', color: '#ffffff', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)' }}>
                      <Trophy size={48} style={{ color: '#ffffff' }} />
                    </div>
                  </div>
                  <h1 className="text-2xl sm:text-4xl font-black uppercase tracking-widest" style={{ color: '#7F1D1D', textShadow: '2px 2px 0 rgba(127,29,29,0.1)' }}>Certificate of Excellence</h1>
                  <p className="text-base sm:text-xl italic font-medium" style={{ color: '#B91C1C' }}>This award is proudly presented to</p>
                </div>
            ...
            <div className="p-4 sm:p-6 bg-gray-50 border-t border-gray-100 flex gap-4">
              ...
              <button onClick={downloadCertificate} disabled={isDownloading}
                className="flex-[2] py-3 bg-brand-red text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-red-800 transition-colors shadow-lg disabled:opacity-50"
              >
