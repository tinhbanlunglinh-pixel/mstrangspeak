    ...
    <AnimatePresence>
      {show && (
        <div className="fixed inset-0 z-[90] flex justify-end">
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 sm:p-5 border-b-4 border-red-50 bg-gradient-to-r from-rose-50 to-white">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-brand-red rounded-xl flex items-center justify-center text-white shadow-md">
                  <Clock size={20} />
                </div>
                <div>
                  <h3 className="text-base font-black text-brand-red-dark uppercase tracking-wider">Lịch sử bài học</h3>
              ...
              {lessons.length === 0 ? (
                ...
                lessons.map((lesson, idx) => (
                  <motion.div
                    ...
                    className="group bg-white border-2 border-red-100/60 rounded-2xl p-3 sm:p-4 hover:border-brand-red/40 hover:shadow-lg transition-all cursor-pointer"
                    ...
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <ChevronRight size={14} className="text-slate-300 group-hover:text-brand-red shrink-0 mt-0.5 transition-colors" />
                        </div>
                        ...
                        <div className="flex items-center gap-2 mt-2 flex-wrap">
                          <span className="px-2 py-0.5 bg-red-100 text-red-700 rounded-full text-[10px] font-black">{lesson.level}</span>
