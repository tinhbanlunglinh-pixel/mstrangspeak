...
export const PosterPreview: React.FC<PosterPreviewProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Text Section */}
      <div className="flex-1 p-3" style={{ backgroundColor: '#ffffff', border: '3px solid #B91C1C', borderRadius: '16px', boxShadow: '0 4px 0 #7F1D1D' }}>
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2" data-html2canvas-ignore>
            <button
              ...
              style={{
                backgroundColor: isPlaying ? '#FEE2E2' : isAudioLoading ? '#f3f4f6' : '#f9fafb',
                color: isPlaying ? '#B91C1C' : isAudioLoading ? '#d1d5db' : '#9ca3af'
              }}
    ...
    <div className="mb-3 px-1 space-y-2">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <button onClick={togglePlay}
          ...
          style={{
            background: isPlaying ? 'linear-gradient(135deg, #B91C1C, #DC2626)' : 'linear-gradient(135deg, #6366f1, #818cf8)',
            color: '#ffffff'
          }}
        >
        ...
        <div className="flex-1 space-y-0.5">
          ...
          >
            <div
              ...
              style={{ width: `${progress}%`, background: 'linear-gradient(90deg, #6366f1, #B91C1C)' }}
            />
            {/* Thumb */}
            <div
